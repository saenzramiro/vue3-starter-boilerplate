			...
			<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
				...
				<div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
					<div class="p-4 md:p-5">
						...
						<div class="mt-1 flex items-center gap-x-2">
							<h3 class="text-xl sm:text-2xl font-medium text-gray-800 dark:text-gray-200">29.4%</h3>
						</div>
					</div>
				</div>
				<!-- End Card -->
				...
				<div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
					<div class="p-4 md:p-5">
						...
						<div class="mt-1 flex items-center gap-x-2">
							<h3 class="text-xl sm:text-2xl font-medium text-gray-800 dark:text-gray-200">56.8%</h3>
						...
						<div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
							...
							>
								<div>
									...
									<p class="text-sm text-gray-600 dark:text-gray-400">Create teams, edit, download and more.</p>
								</div>
								...
								<div>
									<div class="inline-flex gap-x-2">
										<div class="hs-dropdown relative inline-block [--placement:bottom-right]">
											...
											<div
												class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden mt-2 divide-y divide-gray-200 min-w-[12rem] z-20 bg-white shadow-md rounded-lg p-2 mt-2 dark:divide-gray-700 dark:bg-gray-800 dark:border dark:border-gray-700"
										...
										>
											...
											<div
												class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden mt-2 divide-y divide-gray-200 min-w-[12rem] z-20 bg-white shadow-md rounded-lg mt-2 dark:divide-gray-700 dark:bg-gray-800 dark:border dark:border-gray-700"
							...
							<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
								...
								<tbody class="divide-y divide-gray-200 dark:divide-gray-700">
									<tr @click="asd" class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
										...
										<td class="h-px w-px whitespace-nowrap">
											<a class="block relative z-10" href="#">
												<div class="px-6 py-2 flex gap-x-1">
													<svg
														class="flex-shrink-0 w-3 h-3 text-gray-800 dark:text-gray-200"
														xmlns="http://www.w3.org/2000/svg"
														width="16"
														height="16"
														fill="currentColor"
													...
													<svg
														class="flex-shrink-0 w-3 h-3 text-transparent"
														xmlns="http://www.w3.org/2000/svg"
														width="16"
														height="16"
														fill="currentColor"
											...
											<a class="block relative z-10" href="#">
												<div class="px-6 py-2 flex -space-x-2">
													<div class="hs-tooltip inline-flex">
														...
														/>
														<span
															class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded shadow-sm dark:bg-slate-700"
															role="tooltip"
														>
															David Harrison
														</span>
												...
												<div class="hs-dropdown relative inline-block [--placement:bottom-right]">
													...
													>
														<div class="py-2 first:pt-0 last:pb-0">
															...
															<a
																class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
																href="#"
															>
																Rename team
															</a>
										...
										<td class="h-px w-px whitespace-nowrap">
											<a class="block relative z-10" href="#">
												<div class="px-6 py-2 flex -space-x-2">
													<div class="hs-tooltip inline-flex">
														<span
															class="hs-tooltip-toggle inline-flex items-center justify-center h-6 w-6 rounded-full bg-gray-600 ring-2 ring-white dark:bg-slate-400 dark:ring-slate-900"
														>
													...
													<div class="hs-tooltip inline-flex">
														<span
															class="hs-tooltip-toggle inline-flex justify-center items-center h-6 w-6 bg-gray-100 text-xs rounded-full ring-2 ring-white dark:bg-slate-500 dark:text-white dark:ring-slate-900"
														>
